...
cronserver_security_group_id=$(aws ec2 describe-security-groups --filters "Name=vpc-id, Values=${vpcid}, Name=tag-value, Values=*cronserver_sg*" | jq '.SecurityGroups[0].GroupId')
...
variable \"cronserver_security_group_id\" { default = $cronserver_security_group_id }
